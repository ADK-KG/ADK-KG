...
def get_train_path(args):
    if 'NELL' in args.data_dir:
        if not args.model.startswith('point'):
            if args.test:
                train_path = os.path.join(args.data_dir, 'train.dev.large.triples.txt')
            else:
                train_path = os.path.join(args.data_dir, 'train.large.triples.txt')
        else:
            if args.test:
                train_path = os.path.join(args.data_dir, 'train.dev.triples.txt')
            else:
                train_path = os.path.join(args.data_dir, 'train.triples.txt')
    else:
        train_path = os.path.join(args.data_dir, 'train.triples.txt')
